...
class JobsDetailsViewPage extends StatefulWidget {
  final String title;
  final String id;
  const JobsDetailsViewPage({super.key, required this.title, required this.id});

  @override
  State<JobsDetailsViewPage> createState() => _JobsDetailsViewPageState();
}

class _JobsDetailsViewPageState extends State<JobsDetailsViewPage> {
  String bullet = "\u2022";
  @override
