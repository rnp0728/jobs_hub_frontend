...
class JobsAddingPage extends StatefulWidget {
  const JobsAddingPage({super.key});

  @override
  State<JobsAddingPage> createState() => _JobsAddingPageState();
}

class _JobsAddingPageState extends State<JobsAddingPage> {
              ...
              child: Stack(
                children: [
                  Positioned(
                      top: 0,
                      right: 5,
                      child: myJobsNotifier.imageFil.isEmpty
                          ? GestureDetector(
                              onTap: () {
                                myJobsNotifier.pickImage();
                              },
                              child: CircleAvatar(
                          ...
                          : GestureDetector(
                              onTap: () {
                                myJobsNotifier.imageFil.clear();
                                setState(() {});
                              },
                              child: CircleAvatar(
                                backgroundColor: Color(kLightBlue.value),
                                backgroundImage: FileImage(
                                  File(myJobsNotifier.imageFil[0]),
                                ),
                              ),
                            )),
                  Column(
