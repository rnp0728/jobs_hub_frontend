...
class InternshipAddingPage extends StatefulWidget {
  const InternshipAddingPage({super.key});

  @override
  State<InternshipAddingPage> createState() => _InternshipAddingPageState();
}

class _InternshipAddingPageState extends State<InternshipAddingPage> {
              ...
              child: Stack(
                children: [
                  Positioned(
                      top: 0,
                      right: 5,
                      child: myInternshipNotifier.imageFil.isEmpty
                          ? GestureDetector(
                              onTap: () {
                                myInternshipNotifier.pickImage();
                              },
                              child: CircleAvatar(
                          ...
                          : GestureDetector(
                              onTap: () {
                                myInternshipNotifier.imageFil.clear();
                                setState(() {});
                              },
                              child: CircleAvatar(
                                backgroundColor: Color(kLightBlue.value),
                                backgroundImage: FileImage(
                                  File(myInternshipNotifier.imageFil[0]),
                                ),
                              ),
                            )),
                  Column(
                      ...
                      CustomButton(
                        onTap: () async {
                          if (!myInternshipNotifier.validAndSave()) {
                            ...
                            myInternshipNotifier.addInternship(
