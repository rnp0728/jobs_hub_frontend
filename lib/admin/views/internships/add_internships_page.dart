...
class AddInternshipsPage extends StatefulWidget {
  const AddInternshipsPage({super.key});

  @override
  State<AddInternshipsPage> createState() => _AddInternshipsPageState();
}

class _AddInternshipsPageState extends State<AddInternshipsPage> {
