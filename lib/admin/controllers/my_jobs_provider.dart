...
import 'package:jobs_hub/admin/services/posted_jobs_helper.dart';
...
class MyJobsNotifier extends ChangeNotifier {
  ...
  addJob({required JobsReqModel model}) {
    PostedJobsHelper.addAJob(model).then((response) {
      if (response) {
        Get.snackbar(
          'Job Posted',
