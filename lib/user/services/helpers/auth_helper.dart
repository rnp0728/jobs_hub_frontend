...
import 'package:jobs_hub/user/models/response/auth/login_res_model.dart';
...
class AuthHelper {
  ...
  static Future<bool> login(LoginModel model) async {
    ...
    if (response.statusCode == 200) {
      ...
      String token = responseModel.userToken;
      String userId = responseModel.userDetails.id;
      String profile = responseModel.userDetails.profile;
      String userType = responseModel.userDetails.userType;
  ...
  static Future<bool> updatePassword(
    ...
    var url = Uri.https(Config.apiUrl, Config.updatePasswordUrl);
    var response = await client.put(
      url,
      headers: requestHeaders,
      body:
