...
class JobsApplyNowFormPage extends StatefulWidget {
  final GetJobRes job;
  const JobsApplyNowFormPage({
    super.key,
    required this.job,
  });

  @override
  State<JobsApplyNowFormPage> createState() => _JobsApplyNowFormPageState();
}

class _JobsApplyNowFormPageState extends State<JobsApplyNowFormPage> {
